...
class WordOperationsAdmin(admin.ModelAdmin):
    ...
    fieldsets  = (
        ...
        ('文字编辑', { 'classes': ('collapse', 'extrapretty'), 'fields': ('char_edit_op','char_edit_origin','char_edit_replace')}), 
        ('字体设置', { 'classes': ('collapse', 'extrapretty'), 'fields': ('font_op', 'font_name_chinese','font_name_ascii','font_size',
                                 'font_underline', 'font_color', ('font_bold','font_italic'),
                                )}), 
        ('段落格式设置', { 'classes': ('collapse', 'extrapretty'), 'fields': ('paraformat_op','para_alignment', 'para_left_indent','para_right_indent',
